...
from view import print_directory_with_restricted_access, print_biggest_files
from helper import prepare_filter_config
from scanner import traverse_dir


@Halo(text='Scanning files', spinner='bouncingBall', text_color="green")
def main(argv):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--limit', '-limit', '-l', type=int,
                        help='Number of files you want to see in the table. Default value is 10. Maximum accepted value is 200', default=10)
